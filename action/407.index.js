...
module.exports = exports = __webpack_require__(29355)
...
const async = __webpack_require__(75707)
const DSStore = __webpack_require__(48380)
const sizeOf = __webpack_require__(48880)
const validator = __webpack_require__(26142)
const parseColor = __webpack_require__(21616)

const util = __webpack_require__(21395)
const hdiutil = __webpack_require__(20711)
const Pipeline = __webpack_require__(49199)
const schema = __webpack_require__(31036)
...
module.exports = exports = function (options) {
  ...
  pipeline.addStep('Parsing JSON Specification', function (next) {
    ...
    try {
      ...
      if (obj.icons) {
        const legacy = __webpack_require__(32879)
...
const fs = __webpack_require__(57147)
const temp = __webpack_require__(23497)
const util = __webpack_require__(21395)
...
const execa = __webpack_require__(82041)
const pathExists = __webpack_require__(29225)
const util = __webpack_require__(73837)
const xattr = __webpack_require__(71490)
...
var toDataView = __webpack_require__(31761)
...
var streamBuffers = __webpack_require__(19608);
...
module.exports = function(dicts) {
  ...
  if (debug) {
    console.log('create', (__webpack_require__(73837).inspect)(dicts, false, 10));
  }
...
var conversions = __webpack_require__(90103);
...
const parse = __webpack_require__(44003);
const enoent = __webpack_require__(69954);
...
const path = __webpack_require__(71017);
const niceTry = __webpack_require__(13525);
const resolveCommand = __webpack_require__(40923);
const escape = __webpack_require__(19602);
const readShebang = __webpack_require__(29774);
const semver = __webpack_require__(39850);
...
const fs = __webpack_require__(57147);
const shebangCommand = __webpack_require__(81207);
...
const path = __webpack_require__(71017);
const which = __webpack_require__(96491);
const pathKey = __webpack_require__(64134)();
...
var alias = __webpack_require__(49455)
var util = __webpack_require__(73837)

var Entry = __webpack_require__(87565)
var DSStore = __webpack_require__(64295)
...
DSStore.prototype.write = function (filePath, cb) {
  ...
  fs.readFile(__webpack_require__.ab + "DSStore-clean", function (err, buf) {
    if (err) return cb(err)
...
var tn1150 = __webpack_require__(86908)
var bplist = __webpack_require__(64285)
...
const crossSpawn = __webpack_require__(17147);
const stripEof = __webpack_require__(19123);
const npmRunPath = __webpack_require__(65111);
const isStream = __webpack_require__(81589);
const _getStream = __webpack_require__(48622);
const pFinally = __webpack_require__(67574);
const onExit = __webpack_require__(65300);
const errname = __webpack_require__(3453);
const stdio = __webpack_require__(46889);
...
var imul = __webpack_require__(97313)
...
var temp = __webpack_require__(42775)
var randomPath = __webpack_require__(25558)
...
var retry = __webpack_require__(78877)
var WriteStream = __webpack_require__(44524)
...
var temp = __webpack_require__(42775)
var WriteStream = (__webpack_require__(57147).WriteStream)
...
var util = __webpack_require__(73837)
var isProperty = __webpack_require__(83327)
...
const pump = __webpack_require__(97987);
const bufferStream = __webpack_require__(39683);
...
var typeHandlers = __webpack_require__(49444);
...
var typeHandlers = __webpack_require__(49444);
var detector = __webpack_require__(56714);
...
var typeHandlers = {
  bmp: __webpack_require__(92510),
  cur: __webpack_require__(87642),
  dds: __webpack_require__(3978),
  gif: __webpack_require__(3352),
  icns: __webpack_require__(82574),
  ico: __webpack_require__(76496),
  jpg: __webpack_require__(49496),
  png: __webpack_require__(70130),
  psd: __webpack_require__(92240),
  svg: __webpack_require__(83235),
  tiff: __webpack_require__(64406),
  webp: __webpack_require__(9164),
};
...
module.exports = {
  'detect': isCUR,
  'calculate': (__webpack_require__(76496).calculate)
};
...
var readUInt = __webpack_require__(5826);
...
var createIpValidator = __webpack_require__(29422)
...
var genobj = __webpack_require__(42196)
var genfun = __webpack_require__(26726)
var jsonpointer = __webpack_require__(84640)
var xtend = __webpack_require__(40172)
var formats = __webpack_require__(37634)
...
if (process.platform === 'win32' || global.TESTING_WINDOWS) {
  core = __webpack_require__(47273)
} else {
  core = __webpack_require__(58345)
}
...
exports.create = __webpack_require__(53793)
exports.encode = __webpack_require__(4945)
exports.decode = __webpack_require__(47665)
exports.isAlias = __webpack_require__(31807)
...
var assert = __webpack_require__(39491)
var values = __webpack_require__(31350)
...
var imul = __webpack_require__(97313)
var fmix = __webpack_require__(26329)
var encodeUtf8 = __webpack_require__(98682)
...
var convert = __webpack_require__(23023);
...
var path = __webpack_require__(71017)
var murmur32 = __webpack_require__(74547)
var encodeBase32 = __webpack_require__(92024)
...
var shebangRegex = __webpack_require__(15368);
...
var stream = __webpack_require__(12781),
	constants = __webpack_require__(43336),
...
module.exports = __webpack_require__(43336);
module.exports.ReadableStreamBuffer = __webpack_require__(72472);
module.exports.WritableStreamBuffer = __webpack_require__(51171);
...
var unorm = __webpack_require__(95950)
...
var path = __webpack_require__(71017)
var COLON = isWindows ? ';' : ':'
var isexe = __webpack_require__(12636)
...
"use strict";
module.exports = JSON.parse('{"$schema":"http://json-schema.org/draft-04/schema#","type":"object","additionalProperties":false,"properties":{"title":{"type":"string"},"icon":{"type":"string"},"background":{"type":"string"},"background-color":{"type":"string","format":"css-color"},"icon-size":{"type":"integer"},"window":{"type":"object","properties":{"position":{"type":"object","properties":{"x":{"type":"integer"},"y":{"type":"integer"}},"required":["x","y"]},"size":{"type":"object","properties":{"width":{"type":"integer"},"height":{"type":"integer"}},"required":["width","height"]}}},"format":{"type":"string","enum":["UDRW","UDRO","UDCO","UDZO","ULFO","ULMO","UDBZ"]},"filesystem":{"type":"string","enum":["HFS+","APFS"]},"contents":{"type":"array","items":{"type":"object","properties":{"x":{"type":"integer"},"y":{"type":"integer"},"type":{"type":"string","enum":["link","file","position"]},"path":{"type":"string"},"name":{"type":"string"}},"required":["x","y","type","path"]}},"code-sign":{"type":"object","properties":{"signing-identity":{"type":"string"},"identifier":{"type":"string"}},"required":["signing-identity"]}},"required":["title","contents"]}');
